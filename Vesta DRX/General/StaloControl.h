...
#ifndef StaloControlH
#define StaloControlH
...
private:
	...
	INT64  fFrequency;
	INT64  LastfFrequency;
	double fPower;
	double fTemperature;
	bool   fWaitingData;
private:
	bool TestPort(int Port);
	bool SendCommand(String parameter);
...
public:
	...
	__property double Power       = {read= fPower};
	__property double Temperature = {read= fTemperature};
	__property INT64  Frequency   = {read= fFrequency};
};
