...
class Site
{
	private:
		...
		int fStalo_modbus_serial_port;
		int fStalo_modbus_da_channel;
        //synchro
		int flong_pulse_frecuency;
		double flong_pulse_width;
		double flong_pulse_delaySW;
		double flong_pulse_widthSW;

		int fshort_pulse_frecuency;
		double fshort_pulse_width;
		double fshort_pulse_delaySW;
		double fshort_pulse_widthSW;
		//iq
	...
	public:
	  ...
	  __property int    Stalo_modbus_serial_port = { read= fStalo_modbus_serial_port, write= fStalo_modbus_serial_port};
	  __property int    Stalo_modbus_da_channel = { read= fStalo_modbus_da_channel, write= fStalo_modbus_da_channel};


			//synchro
	  __property int    long_pulse_frecuency = { read= flong_pulse_frecuency, write= flong_pulse_frecuency};
	  __property double long_pulse_width  = { read= flong_pulse_width , write= flong_pulse_width};
	  __property double long_pulse_delaySW  = { read= flong_pulse_delaySW , write= flong_pulse_delaySW };
	  __property double long_pulse_widthSW  = { read= flong_pulse_widthSW , write= flong_pulse_widthSW };

	  __property int    short_pulse_frecuency = { read= fshort_pulse_frecuency, write= fshort_pulse_frecuency};
	  __property double short_pulse_width  = { read= fshort_pulse_width , write= fshort_pulse_width };
	  __property double short_pulse_delaySW  = { read= fshort_pulse_delaySW , write= fshort_pulse_delaySW };
	  __property double short_pulse_widthSW  = { read= fshort_pulse_widthSW , write= fshort_pulse_widthSW };
	  ...
	  __property int    SpeckleDistance = { read= fSpeckleDistance,    write= fSpeckleDistance};
