...
const int Value_Sync_Output      = 6;    // By Robert
...
const int LP_MODE1       = 4; //By Robert
...
//By Robert
//const int PRF_Rate_54   = 1;
//const int PRF_Rate_43   = 2;
//const int PRF_Rate_32   = 3;
//const int PRF_Rate_None = 0;
...
const RAW_HALF_DEGREES = 726;
	//   Setting Synchro
const int   CodeSynchroHV = 268435456;     // by Robert
const int   CodeSynchroTxMa = 536870912;
const int   CodeSynchroRFG = 805306368;
const int   CodeSynchroSW = 1073741824;
const int   CodeSynchroPRFSetting =1342177280;
  //------------------------------------------------
