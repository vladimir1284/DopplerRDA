...
class PackageManager
{
	private:
		...
		short Distance(short Ang1, short Ang2);
	...
	public:
		...
		void __fastcall Data_Sector(System::TObject* Sender, short Az, short El, short rays, short mode, short ndata, float *Power, float *dBT, float *dBZ, float *V, float *W, float *SQI, float *LOG, float *SIG, float *CCOR);
