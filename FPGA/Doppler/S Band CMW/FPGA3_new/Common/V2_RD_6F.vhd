...
--  2.4     R. Williams    07-06-06    Corrected problem found in
--                                     Six FIFO Read interface where
--                                     deasserting read request early
--                                     creates repeated data values.
--  3.0     R. Williams    22-01-08    Redesigned the Read interface
--                                     to move data into data regs
--                                     DRA_Fx and DRB_Fx when reading
--                                     from a FIFO is halted due to
--                                     de-assertion of the READ_REQ
--                                     signal. Previously data would
--                                     be held in the pipeline of
--                                     carrier read fifo output and
--                                     input register until reading
--                                     commenced.
--
-- ==============================================================
...
--signal IR_CEv    : std_logic_vector(5 downto 0);
  ...
  -- Logic added to handle situation where
  -- INFIFO_READ_REQ is de-asserted. In this
  -- special case, the data is moved into
  -- data registers DRA_Fx and DRB_Fx.
  signal SPECIALc    : std_logic_vector(5 downto 0);
  signal SPECIAL     : std_logic_vector(5 downto 0);
  signal SPECIAL_DL  : std_logic_vector(5 downto 0);
  signal READ_RQ_DL1 : std_logic_vector(5 downto 0);
  signal READ_RQ_DL2 : std_logic_vector(5 downto 0);
  ...
  constant initv_fb   : bit_vector := X"FB";   -- LUT3 equation
  ...
  constant initv_00a8 : bit_vector := X"00A8"; -- LUT4 equation
  ...
  attribute init of iT0     : label is "02";
  attribute init of iT1     : label is "02";
  attribute init of iT2     : label is "02";
  attribute init of iT3     : label is "02";
  attribute init of iT4     : label is "02";
  attribute init of iT5     : label is "02";
  ...
  attribute init of iRDY_F3 : label is "FB";
  attribute init of iRDY_F4 : label is "FB";
  attribute init of iRDY_F5 : label is "FB";
  attribute init of iRDY_F6 : label is "FB";
  attribute init of iRDY_F7 : label is "FB";
  attribute init of iRDY_F8 : label is "FB";
...
--attribute init of iCRDY5  : label is "02";
  ...
  attribute init of iREADY0 : label is "00A8";
  attribute init of iREADY1 : label is "00A8";
  attribute init of iREADY2 : label is "00A8";
  attribute init of iREADY3 : label is "00A8";
  attribute init of iREADY4 : label is "00A8";
  attribute init of iREADY5 : label is "00A8";
...
-- New T logic
--T(0) <= (NOT INFIFO_READ_REQ(0)) AND CURR_FIFO(0) AND (NOT SPECIAL(0));
--T(1) <= (NOT INFIFO_READ_REQ(1)) AND CURR_FIFO(1) AND (NOT SPECIAL(1));
--T(2) <= (NOT INFIFO_READ_REQ(2)) AND CURR_FIFO(2) AND (NOT SPECIAL(2));
--T(3) <= (NOT INFIFO_READ_REQ(3)) AND CURR_FIFO(3) AND (NOT SPECIAL(3));
--T(4) <= (NOT INFIFO_READ_REQ(4)) AND CURR_FIFO(4) AND (NOT SPECIAL(4));
--T(5) <= (NOT INFIFO_READ_REQ(5)) AND CURR_FIFO(5) AND (NOT SPECIAL(5));
...
-- Previous IR_CE_B logic
--IR_CE_B <= NOT (IR_A AND (NOT (IR_B OR IR_C OR IR_D)));
...
-- Previous IR_CE_C logic
--IR_CE_C <= NOT (IR_A AND (NOT (IR_B OR IR_C OR IR_D)));
...
-- Previous READY logic
--READY <= (INFIFO_READ_REQ AND EF_REG) OR (INFIFO_READ_REQ AND DRBV);

-- New READY logic
--READY <= (INFIFO_READ_REQ AND EF_REG AND (NOT SPECIAL)) OR
--         (INFIFO_READ_REQ AND DRBV   AND (NOT SPECIAL));

  iREADY0 : lut4
    --pragma translate_off
    generic map (init => initv_00a8)
    --pragma translate_on
    port map (
...
-- New RDY_FN logic
--RDY_FN3 <= (NOT INFIFO_READ_REQ(0)) OR READY(1) OR SPECIAL(0);
--RDY_FN4 <= (NOT INFIFO_READ_REQ(1)) OR READY(0) OR SPECIAL(1);
--RDY_FN5 <= (NOT INFIFO_READ_REQ(2)) OR READY(3) OR SPECIAL(2);
--RDY_FN6 <= (NOT INFIFO_READ_REQ(3)) OR READY(2) OR SPECIAL(3);
--RDY_FN7 <= (NOT INFIFO_READ_REQ(4)) OR READY(5) OR SPECIAL(4);
--RDY_FN8 <= (NOT INFIFO_READ_REQ(5)) OR READY(4) OR SPECIAL(5);

  iRDY_F3 : lut3
    --pragma translate_off
    generic map (init => initv_fb)
    --pragma translate_on
    port map (
      i0 => READY(1),
      i1 => INFIFO_READ_REQ(0),
...
-- Previous CURR_RDY logic v1
--CURR_RDY(0) <= (CURR_FIFO(0) OR INFIFO_READ_REQ(0)) AND (NOT READY(1)) AND (NOT RDY_FN0);
--CURR_RDY(1) <= (CURR_FIFO(1) OR INFIFO_READ_REQ(1)) AND (NOT READY(0)) AND (NOT RDY_FN0);
--CURR_RDY(2) <= (CURR_FIFO(2) OR INFIFO_READ_REQ(2)) AND (NOT READY(3)) AND (NOT RDY_FN1);
--CURR_RDY(3) <= (CURR_FIFO(3) OR INFIFO_READ_REQ(3)) AND (NOT READY(2)) AND (NOT RDY_FN1);
--CURR_RDY(4) <= (CURR_FIFO(4) OR INFIFO_READ_REQ(4)) AND (NOT READY(5)) AND (NOT RDY_FN2);
--CURR_RDY(5) <= (CURR_FIFO(5) OR INFIFO_READ_REQ(5)) AND (NOT READY(4)) AND (NOT RDY_FN2);

-- New CURR_RDY logic
  CURR_RDY(0) <= (CURR_FIFO(0) OR INFIFO_READ_REQ(0)) AND (NOT SPECIAL(0)) AND (NOT READY(1)) AND (NOT RDY_FN0);
  CURR_RDY(1) <= (CURR_FIFO(1) OR INFIFO_READ_REQ(1)) AND (NOT SPECIAL(1)) AND (NOT READY(0)) AND (NOT RDY_FN0);
  CURR_RDY(2) <= (CURR_FIFO(2) OR INFIFO_READ_REQ(2)) AND (NOT SPECIAL(2)) AND (NOT READY(3)) AND (NOT RDY_FN1);
  CURR_RDY(3) <= (CURR_FIFO(3) OR INFIFO_READ_REQ(3)) AND (NOT SPECIAL(3)) AND (NOT READY(2)) AND (NOT RDY_FN1);
  CURR_RDY(4) <= (CURR_FIFO(4) OR INFIFO_READ_REQ(4)) AND (NOT SPECIAL(4)) AND (NOT READY(5)) AND (NOT RDY_FN2);
  CURR_RDY(5) <= (CURR_FIFO(5) OR INFIFO_READ_REQ(5)) AND (NOT SPECIAL(5)) AND (NOT READY(4)) AND (NOT RDY_FN2);

  SPECIALc <= ((NOT INFIFO_READ_REQ) AND READ_RQ_DL1) OR ((NOT READ_RQ_DL1) AND READ_RQ_DL2);

  iSPECIAL0 : FDC port map (SPECIAL(0), D=>SPECIALc(0), C=>CLK, CLR=>RST);
  iSPECIAL1 : FDC port map (SPECIAL(1), D=>SPECIALc(1), C=>CLK, CLR=>RST);
  iSPECIAL2 : FDC port map (SPECIAL(2), D=>SPECIALc(2), C=>CLK, CLR=>RST);
  iSPECIAL3 : FDC port map (SPECIAL(3), D=>SPECIALc(3), C=>CLK, CLR=>RST);
  iSPECIAL4 : FDC port map (SPECIAL(4), D=>SPECIALc(4), C=>CLK, CLR=>RST);
  iSPECIAL5 : FDC port map (SPECIAL(5), D=>SPECIALc(5), C=>CLK, CLR=>RST);

  iRD_DL10 : FDC port map (READ_RQ_DL1(0), D=>INFIFO_READ_REQ(0), C=>CLK, CLR=>RST);
  iRD_DL11 : FDC port map (READ_RQ_DL1(1), D=>INFIFO_READ_REQ(1), C=>CLK, CLR=>RST);
  iRD_DL12 : FDC port map (READ_RQ_DL1(2), D=>INFIFO_READ_REQ(2), C=>CLK, CLR=>RST);
  iRD_DL13 : FDC port map (READ_RQ_DL1(3), D=>INFIFO_READ_REQ(3), C=>CLK, CLR=>RST);
  iRD_DL14 : FDC port map (READ_RQ_DL1(4), D=>INFIFO_READ_REQ(4), C=>CLK, CLR=>RST);
  iRD_DL15 : FDC port map (READ_RQ_DL1(5), D=>INFIFO_READ_REQ(5), C=>CLK, CLR=>RST);

  iRD_DL20 : FDC port map (READ_RQ_DL2(0), D=>READ_RQ_DL1(0), C=>CLK, CLR=>RST);
  iRD_DL21 : FDC port map (READ_RQ_DL2(1), D=>READ_RQ_DL1(1), C=>CLK, CLR=>RST);
  iRD_DL22 : FDC port map (READ_RQ_DL2(2), D=>READ_RQ_DL1(2), C=>CLK, CLR=>RST);
  iRD_DL23 : FDC port map (READ_RQ_DL2(3), D=>READ_RQ_DL1(3), C=>CLK, CLR=>RST);
  iRD_DL24 : FDC port map (READ_RQ_DL2(4), D=>READ_RQ_DL1(4), C=>CLK, CLR=>RST);
  iRD_DL25 : FDC port map (READ_RQ_DL2(5), D=>READ_RQ_DL1(5), C=>CLK, CLR=>RST);
