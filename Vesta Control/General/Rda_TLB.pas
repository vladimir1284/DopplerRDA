...
// PASTLWTR : 1.2
// File generated on 4/5/2012 1:00:24 AM from Type Library described below.
...
// Server Object    : TVestaRda
// Help String      : Vesta Rda Object
// Default Interface: IVestaRda
// Def. Intf. DISP? : No
// Event   Interface: IVestaRdaEvents
// TypeFlags        : (2) CanCreate
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TVestaRdaProperties= class;
{$ENDIF}
  TVestaRda = class(TOleServer)
  private
    FIntf:        IVestaRda;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       TVestaRdaProperties;
    function      GetServerProperties: TVestaRdaProperties;
{$ENDIF}
    function      GetDefaultInterface: IVestaRda;
  protected
    procedure InitServerData; override;
    procedure InvokeEvent(DispID: TDispID; var Params: TVariantArray); override;
    function Get_Radar: IRadar;
    function Get_TxsRxs: ITxsRxs;
    function Get_Antenna: IAntenna;
    function Get_Configuration: IConfiguration;
    function Get_Observations: IObservations;
    function Get_MaxLogEntries: Integer;
    function Get_Version: WideString;
    function Get_SystemDateTime: Double;
    function Get_SystemTimeZone: Double;
    function Get_Statistics: IStatistics;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: IVestaRda);
    procedure Disconnect; override;
    function LogMessageTitles(out LogMessages: PSafeArray; out MsgCount: Integer): HResult;
    procedure LogMessage(MsgCode: Integer; out DateTime: TDateTime; out Category: Integer; 
                         out Client: WideString; out Title: WideString; out Msg: WideString; 
                         out Zone: WideString);
    property DefaultInterface: IVestaRda read GetDefaultInterface;
    property Radar: IRadar read Get_Radar;
    property TxsRxs: ITxsRxs read Get_TxsRxs;
    property Antenna: IAntenna read Get_Antenna;
    property Configuration: IConfiguration read Get_Configuration;
  ...
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TVestaRdaProperties read GetServerProperties;
{$ENDIF}
  end;
...
// *********************************************************************//
 TVestaRdaProperties = class(TPersistent)
  private
    FServer:    TVestaRda;
    function    GetDefaultInterface: IVestaRda;
    constructor Create(AServer: TVestaRda);
  protected
    function Get_Radar: IRadar;
    function Get_TxsRxs: ITxsRxs;
    function Get_Antenna: IAntenna;
...
procedure TVestaRda.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{6C8CA0BB-155C-4FF7-8CA2-35A5CA82B9ED}';
    IntfIID:   '{0E77DAC8-AD7C-468B-B8A8-87667FE2DF3C}';
    EventIID:  '{E91350B6-543B-4A3E-8FD8-64FA3D4D5D48}';
    LicenseKey: nil;
    Version: 500);
begin
...
begin
  ...
  begin
    punk := GetServer;
    ConnectEvents(punk);
    Fintf:= punk as IVestaRda;
  end;
end;

procedure TVestaRda.ConnectTo(svrIntf: IVestaRda);
begin
  Disconnect;
  FIntf := svrIntf;
  ConnectEvents(FIntf);
...
procedure TVestaRda.DisConnect;
begin
  if Fintf <> nil then
  begin
...
function TVestaRda.GetDefaultInterface: IVestaRda;
begin
  if FIntf = nil then
    Connect;
...
constructor TVestaRda.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TVestaRdaProperties.Create(Self);
{$ENDIF}
end;
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TVestaRda.GetServerProperties: TVestaRdaProperties;
begin
  Result := FProps;
end;
{$ENDIF}

procedure TVestaRda.InvokeEvent(DispID: TDispID; var Params: TVariantArray);
begin
  case DispID of
...
begin
    Result := DefaultInterface.Radar;
end;

function TVestaRda.Get_TxsRxs: ITxsRxs;
begin
    Result := DefaultInterface.TxsRxs;
end;

function TVestaRda.Get_Antenna: IAntenna;
begin
    Result := DefaultInterface.Antenna;
end;
...
begin
    Result := DefaultInterface.Observations;
end;

function TVestaRda.Get_MaxLogEntries: Integer;
begin
    Result := DefaultInterface.MaxLogEntries;
end;
...
begin
    Result := DefaultInterface.SystemDateTime;
end;

function TVestaRda.Get_SystemTimeZone: Double;
begin
    Result := DefaultInterface.SystemTimeZone;
end;
...
begin
  Result := DefaultInterface.LogMessageTitles(LogMessages, MsgCount);
end;

procedure TVestaRda.LogMessage(MsgCode: Integer; out DateTime: TDateTime; out Category: Integer; 
                               out Client: WideString; out Title: WideString; out Msg: WideString; 
                               out Zone: WideString);
begin
  DefaultInterface.LogMessage(MsgCode, DateTime, Category, Client, Title, Msg, Zone);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TVestaRdaProperties.Create(AServer: TVestaRda);
begin
  inherited Create;
  FServer := AServer;
end;

function TVestaRdaProperties.GetDefaultInterface: IVestaRda;
begin
  Result := FServer.DefaultInterface;
end;

function TVestaRdaProperties.Get_Radar: IRadar;
begin
    Result := DefaultInterface.Radar;
end;

function TVestaRdaProperties.Get_TxsRxs: ITxsRxs;
begin
    Result := DefaultInterface.TxsRxs;
end;

function TVestaRdaProperties.Get_Antenna: IAntenna;
begin
    Result := DefaultInterface.Antenna;
end;

function TVestaRdaProperties.Get_Configuration: IConfiguration;
begin
    Result := DefaultInterface.Configuration;
end;

function TVestaRdaProperties.Get_Observations: IObservations;
begin
    Result := DefaultInterface.Observations;
end;

function TVestaRdaProperties.Get_MaxLogEntries: Integer;
begin
    Result := DefaultInterface.MaxLogEntries;
end;

function TVestaRdaProperties.Get_Version: WideString;
begin
    Result := DefaultInterface.Version;
end;

function TVestaRdaProperties.Get_SystemDateTime: Double;
begin
    Result := DefaultInterface.SystemDateTime;
end;

function TVestaRdaProperties.Get_SystemTimeZone: Double;
begin
    Result := DefaultInterface.SystemTimeZone;
end;

function TVestaRdaProperties.Get_Statistics: IStatistics;
begin
    Result := DefaultInterface.Statistics;
end;
...
procedure Register;
begin
  RegisterComponents(dtlServerPage, [TVestaRda]);
end;
