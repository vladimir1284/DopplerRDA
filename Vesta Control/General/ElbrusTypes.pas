...
// Digital Input masks
  ...
  di_Excitacion                  = DigitalInput(1) shl dib_Excitacion;
...
const
  ...
  AntennaOkQuery  = di_Antena_Ventilacion_On or di_Fuente_Encoders or di_Antena_Local or di_Excitacion or di_Antena_Limite_N or di_Antena_Limite_P or di_Cupula_Cerrada;
  AntennaOkResult = di_Antena_Ventilacion_On or di_Fuente_Encoders or di_Cupula_Cerrada or di_Excitacion;
...
initialization
  ...
  DI_Names[dib_Excitacion                 ] := 'Antena_Excitacion';
