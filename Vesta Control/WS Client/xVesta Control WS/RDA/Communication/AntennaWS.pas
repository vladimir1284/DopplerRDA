...
type
  ...
  ['{AF956BBF-4A7C-B97D-F274-D183551A3508}']
    ...
    property Antena_Listo: boolean read Get_Antena_Listo;
    property Averia_Excitacion: boolean read Get_Averia_Excitacion;
    property Limite_N: boolean read Get_Limite_N;
    property Limite_P: boolean read Get_Limite_P;
    property Acc_Listo: boolean read Get_Acc_Listo;
    property Cupula_Abierta: boolean read Get_Cupula_Abierta;
    property Acc_On: boolean read Get_Acc_On;
  end;
