...
interface
  ...
  type
    ...
    private
      ...
      function  GetAverage( I : integer ) : TSample;
    ...
    published
      ...
      property Average1     : TSample index 0 read GetAverage;
      property Average2     : TSample index 1 read GetAverage;
...
{ TVideo methods }
  ...
  function TVideo.GetAverage( I : integer ) : TSample;
  var
    J : integer;
    S : cardinal;
    C : cardinal;
        ...
        then
          with aCanvas do
            begin
              ...
              Pen.Style := psSolid;
              X := 0;
              Y := Level - Data^[StartCell] * ValuePixels div ValuePoints;
              MoveTo( X, Y );
              ...
              while (X < Width + SamplePixels) and (D <= DataSize) do
                begin
                  ...
                  for I := D - SamplePoints to D - 1 do
                    inc( S, Data^[I] );
                  S := (S div SamplePoints) * ValuePixels div ValuePoints;
                  if S >  10000
                    then S :=  10000;
                  if S < -10000
                    then S := -10000;
