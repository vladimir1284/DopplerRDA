...
function TTxRxCh2WS.Get_Rx_Anodo: boolean;
begin
  Result := (Snapshot.Digital_Input and di_Rx2_Anodo) <> 0;
end;

function TTxRxCh2WS.Get_Rx_Averia: boolean;
begin
  Result := (Snapshot.Digital_Input and di_Rx2_Averia) <> 0;
end;

function TTxRxCh2WS.Get_Rx_Caldeo: boolean;
begin
  Result := (Snapshot.Digital_Input and di_Rx2_Caldeo) <> 0;
end;

function TTxRxCh2WS.Get_Rx_Correccion: boolean;
begin
...
function TTxRxCh2WS.Get_Tx_Anodo: boolean;
begin
  Result := (Snapshot.Digital_Input and di_Tx2_Anodo) <> 0;
end;

function TTxRxCh2WS.Get_Tx_Averia: boolean;
begin
  Result := (Snapshot.Digital_Input and di_Tx2_Averia) <> 0;
end;

function TTxRxCh2WS.Get_Tx_Caldeo: boolean;
begin
  Result := (Snapshot.Digital_Input and di_Tx2_Caldeo) <> 0;
end;

function TTxRxCh2WS.Get_Tx_Listo: boolean;
begin
...
function TTxRxCh2WS.Get_Tx_Standby: boolean;
begin
  Result := (Snapshot.Digital_Output and do_Tx2_Standby) <> 0;
end;

function TTxRxCh2WS.Get_TxRx_Ajuste: boolean;
begin
...
procedure TTxRxCh2WS.Set_Rx_Correccion(value: boolean);
begin
  if InControl
    then Elbrus.Rx2_Correccion(value);
end;

procedure TTxRxCh2WS.Set_Trabajo(value: boolean);
begin
  if InControl
    then
      begin
...
procedure TTxRxCh2WS.Set_Tx_Standby(value: boolean);
begin
  if InControl
...
function TTxRxCh2WS.Get_Rx_CMG: boolean;
begin
  Result := (Snapshot.Digital_Output and do_Rx2_CMG) <> 0;
end;

function TTxRxCh2WS.Get_Rx_CMS: boolean;
begin
...
procedure TTxRxCh2WS.Set_Rx_CMG(Value: boolean);
begin
  if InControl
    then Elbrus.Rx2_CMG(Value);
end;

procedure TTxRxCh2WS.Set_Rx_CMS(Value: boolean);
begin
  if InControl
