...
public:
	...
	void Set_Configuration(TSettings* data);
...
void TDRX_Configuration_WSImpl::Set_Configuration(TSettings* data){
	ThisSite->ImportData(data);
}

TSettings* TDRX_Configuration_WSImpl::Get_Configuration(){
	return ThisSite->ExportData();
}
