...
{ Changes:                                                                     }
{                                                                              }
{   - Changed name to LibZ.pas fo avoid conflict with Delphi unit ZLib.pas     }
{   - Changed type of fields in z_stream from cardinal to longint in order     }
{     to maintain compatibility with Delphi ZLib.pas                           }
{                                                                              }
{   Marco Perez, 07/08/2002                                                    }
{                                                                              }
{******************************************************************************}

unit LibZ;  // Changed name from ZLib to avoid conflit with delphi release
