...
// WSDL     : http://localhost:8888/wsdl/ITxRxCh2WS
// Encoding : utf-8
// Version  : 1.0
// (3/30/2012 11:44:21 AM - 1.33.2.5)
// ************************************************************************ //
...
type
  ...
  // port      : ITxRxCh2WSPort
  // URL       : http://localhost:8888/soap/ITxRxCh2WS
  // ************************************************************************ //
  ITxRxCh2WS = interface(IInvokable)
...
const
  defWSDL = 'http://localhost:8888/wsdl/ITxRxCh2WS';
  defURL  = 'http://localhost:8888/soap/ITxRxCh2WS';
